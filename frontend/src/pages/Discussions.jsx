...
const Discussions = () => {
  ...
  return (
    <div className="main-container flex flex-row lg:pt-4 lg:pr-16 lg:pl-4">
      <div className="side-nav flex flex-col gap-y-6 py-12 pr-8 border-r">
        <Link
          to="/discussions"
                ...
                <div className="input-and-error flex flex-col gap-y-1">
                  ...
                  <input
                    ...
                    className={`description-input h-8 w-full rounded border  border-solid focus:border-primary_light text-sb1 pl-4 placeholder:text-sb1 ${
                      errors.description ? "error-class border-destructive" : ""
                    }`}
                  />
                  {errors.description && (
                    <p className="error-response text-destructive_light text-b4">
              ...
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  <p className="pl-4 pr-4 pt-1 text-sb1">
                    ...
                    opinion-based conversations, and exchange perspectives about
                    a technical concept. See full Discussions guidelines.
                  </p>
                </AccordionContent>
              </AccordionItem>
            </Accordion>
              ...
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  <p className="pl-4 pr-4 pt-1 text-sb1">
                    ...
                    sometimes while learning, people make mistakes. See code of
                    conduct.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  <p className="pl-4 pr-4 pt-1 text-sb1">
                    ...
                    you must disclose your affiliation. See spam guidelines and
                    best practices.
                  </p>
                </AccordionContent>
              </AccordionItem>
